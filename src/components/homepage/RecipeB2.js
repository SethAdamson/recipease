...
class RecipeB2 extends Component {
    constructor() {
        super();
                ...
                <Parallax speed={-2} percentage={1}>
                    <RecipeBoxDiv>
                        ...
                        <article>
                            ...
                            <footer>
                                <h5 style={{ textAlign: "center", fontSize: "1rem" }}>Serves: 24</h5>
                                <div>
                                    <p>45 min</p>
                                </div>
                            </footer>
...
export default connect(mapStateToProps, { getRecipes })(RecipeB2)